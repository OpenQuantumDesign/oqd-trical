...
from utilities import zeeman_energy_shift
...
class Chamber():
    ...
    def set_laser_wavelength_from_transition(self, laser_index, transition):
        ...
        Mutates:
        - .wavelength attribute of laser with specified laser index; set to wvl
        '''
    ...
    def set_laser_intensity_from_pi_time(self, laser_index, pi_time, transition):
        ...
        Mutates:
        - .I and .I_0 atttributes of laser with specified laser index
        '''
    ...
    def set_laser_intensity_from_rabi_frequency(self, laser_index, rabi_frequency, transition):
        '''
        *Basically a wrapper for set_intensity_from_pi_time*
    ...
    def compute_matrix_element(self, laser, transition):
        ...
        Returns:
        - Multipole matrix elements for E1, E2 transitions
        Mutates:
        - NOTHING 
